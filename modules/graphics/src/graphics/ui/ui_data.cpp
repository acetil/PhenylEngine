...
bool graphics::ui::fromdata (const util::DataValue& dataVal, Axis& val) {
...
util::DataValue graphics::ui::todata (const Axis& val) {
    switch (val) {
        case Axis::UP:
...
bool graphics::ui::fromdata (const util::DataValue& dataVal, FlexAlign& val) {
    if (!dataVal.is<std::string>()) {
        return false;
    }
...
util::DataValue graphics::ui::todata (const FlexAlign& val) {
    switch (val) {
...
bool graphics::ui::fromdata (const util::DataValue& dataVal, FlexJustify& val) {
    if (!dataVal.is<std::string>()) {
        return false;
    }
...
util::DataValue graphics::ui::todata (const FlexJustify& val) {
    switch (val) {
...
bool graphics::ui::fromdata (const util::DataValue& dataVal, FloatAnchor& val) {
    if (!dataVal.is<std::string>()) {
        return false;
    }
...
util::DataValue graphics::ui::todata (const FloatAnchor& val) {
    switch (val) {
