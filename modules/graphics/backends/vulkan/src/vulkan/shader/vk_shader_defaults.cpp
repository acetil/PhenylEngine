...
void VulkanShaderManager::loadDefaultShaders () {
    loadDefault("phenyl/shaders/box",
        builder()
    ...
    loadDefault("phenyl/shaders/debug",
        builder()
    ...
    loadDefault("phenyl/shaders/sprite",
        builder()
    ...
    loadDefault("phenyl/shaders/canvas",
        builder()
    ...
    loadDefault("phenyl/shaders/particle",
        builder()
    ...
    loadDefault("phenyl/shaders/blinn_phong",
        builder()
    ...
    loadDefault("phenyl/shaders/shadow_map",
        builder()
    ...
    loadDefault("phenyl/shaders/mesh_prepass",
        builder()
    ...
    loadDefault("phenyl/shaders/postprocess/noop",
        builder()
    ...
    loadDefault("phenyl/shaders/test",
        builder()
