...
public:
    ColumnWidget (ColumnDirection dir, LayoutArrangement arrangement, LayoutAlignment alignment,
        const Modifier& modifier);

    template<std::derived_from<Widget>... Args>
    explicit ColumnWidget(const Modifier& modifier, Args&&... args) :
        ColumnWidget{ColumnDirection::DOWN, LayoutArrangement::START, LayoutAlignment::START, modifier} {
        (
            [&] {
                pushBack(args);
            }(),
    ...
    template<std::derived_from<Widget>... Args>
    explicit ColumnWidget(ColumnDirection dir, const Modifier& modifier, Args&&... args) :
        ColumnWidget{dir, LayoutArrangement::START, LayoutAlignment::START, modifier} {
        (
            [&] {
                pushBack(args);
            }(),
    ...
    template<std::derived_from<Widget>... Args>
    ColumnWidget(ColumnDirection dir, LayoutArrangement arrangement, const Modifier& modifier, Args&&... args) :
        ColumnWidget{dir, arrangement, LayoutAlignment::START, modifier} {
        (
            [&] {
                pushBack(args);
            }(),
    ...
    ColumnWidget(ColumnDirection dir, LayoutArrangement arrangement, LayoutAlignment alignment,
        const Modifier& modifier, Args&&... args) :
        ColumnWidget{dir, arrangement, alignment, modifier} {
        (
            [&] {
                pushBack(args);
            }(),
...
public:
    ...
    template<std::derived_from<Widget>... Args>
    explicit RowWidget(const Modifier& modifier, Args&&... args) :
        RowWidget{RowDirection::LEFT, LayoutArrangement::START, LayoutAlignment::START, modifier} {
        (
            [&] {
                pushBack(args);
            }(),
    ...
    template<std::derived_from<Widget>... Args>
    explicit RowWidget(RowDirection dir, const Modifier& modifier, Args&&... args) :
        RowWidget{dir, LayoutArrangement::START, LayoutAlignment::START, modifier} {
        (
            [&] {
                pushBack(args);
            }(),
    ...
    template<std::derived_from<Widget>... Args>
    RowWidget(RowDirection dir, LayoutArrangement arrangement, const Modifier& modifier, Args&&... args) :
        RowWidget{dir, arrangement, LayoutAlignment::START, modifier} {
        (
            [&] {
                pushBack(args);
            }(),
    ...
    RowWidget(RowDirection dir, LayoutArrangement arrangement, LayoutAlignment alignment, const Modifier& modifier,
        Args&&... args) :
        RowWidget{dir, arrangement, alignment, modifier} {
        (
            [&] {
                pushBack(args);
            }(),
