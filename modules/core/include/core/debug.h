...
void debugWorldRect (glm::vec2 pos1, glm::vec2 pos2, glm::vec2 pos3, glm::vec2 pos4, glm::vec4 colour,
    glm::vec4 outlineColour = glm::vec4{});
void debugWorldRectOutline (glm::vec2 pos1, glm::vec2 pos2, glm::vec2 pos3, glm::vec2 pos4,
    glm::vec4 outlineColour = glm::vec4{});
...
void debugRect (glm::vec2 pos1, glm::vec2 pos2, glm::vec2 pos3, glm::vec2 pos4, glm::vec4 colour,
    glm::vec4 outlineColour = glm::vec4{});
...
void debugScreenRect (glm::vec2 pos1, glm::vec2 pos2, glm::vec2 pos3, glm::vec2 pos4, glm::vec4 colour,
    glm::vec4 outlineColour);
void debugWorldLine (glm::vec2 start, glm::vec2 end, glm::vec4 colour);
