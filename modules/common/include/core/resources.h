...
namespace phenyl::core {
    ...
    template <typename T>
    concept ComponentType = !std::derived_from<std::remove_cvref_t<T>, IResource> && !detail::is_resources_v<std::remove_cvref_t<T>> && !detail::is_bundle_v<std::remove_cvref_t<T>> && !std::same_as<std::remove_cvref_t<T>, core::Entity>;
}
