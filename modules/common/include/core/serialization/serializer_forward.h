...
#define PHENYL_DECLARE_SERIALIZABLE(T) ::phenyl::core::ISerializable<T>& phenyl_GetSerializable (::phenyl::core::detail::SerializableMarker<T>);
#define PHENYL_SERIALIZABLE_INTRUSIVE(T) friend ::phenyl::core::ISerializable<T>& phenyl_GetSerializable (::phenyl::core::detail::SerializableMarker<T>);