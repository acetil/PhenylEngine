...
public:
    DynamicLibFunction (std::weak_ptr<detail::DynamicLibImpl> dynamicLibrary, void* funcPtr) :
        m_dynamicLibrary{std::move(dynamicLibrary)},
        func{reinterpret_cast<R (*)(Args...)>(funcPtr)} {
