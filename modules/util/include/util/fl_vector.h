...
namespace detail {
    ...
    public:
        ...
        FLVectorIterator (FlVectorItem<T>* items, size_t size, size_t pos = 0) :
            m_items{items},
            m_size{size},
            m_pos{pos} {
            findFirst();
        ...
        bool operator== (const iterator& other) const {
            return (m_items == nullptr && other.m_items == nullptr) ||
                (m_items == other.m_items && m_pos == other.m_pos);
        }
    ...
    public:
        ...
        FLVectorPairIterator (FlVectorItem<T>* items, size_t size, size_t pos = 0) :
            m_items{items},
            m_size{size},
            m_pos{pos} {
            findFirst();
...
public:
    ...
    FLVector (const FLVector<T>& other) :
    ...
    FLVector (FLVector<T>&& other) noexcept :
        m_presentNum{other.m_presentNum},
        m_listSize{other.m_listSize},
        m_capacity{other.m_capacity},
        m_flHead{other.m_flHead} {
    ...
    void remove (std::size_t index) {
        ...
        PHENYL_ASSERT_MSG(m_data[index].isPresent(), "Attempted to remove already removed element {} of FLVector!",
            index);
