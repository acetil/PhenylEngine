...
namespace breakout {
    ...
    struct Paddle {
        ...
        void update (const phenyl::Resources<const phenyl::Camera2D, const phenyl::FixedDelta>& resources, const phenyl::Bundle<const phenyl::GlobalTransform2D, phenyl::RigidBody2D>& bundle);
    };
